...
{
    public class StanderSpecularDisplacementGUI : ShaderGUI
    {
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                // displacement and tessellation settings
                GUILayout.Label("Displacement/Tessellation", EditorStyles.boldLabel);
                EditorGUI.indentLevel++;
                m_MaterialEditor.ShaderProperty(displacementMap, Styles.displacementTextureText);
                m_MaterialEditor.ShaderProperty(displacementValue, Styles.displacementValueText);
                m_MaterialEditor.ShaderProperty(tessellationLevel, Styles.tessellationLevelText);
                m_MaterialEditor.ShaderProperty(phongTessStrength, Styles.phongTessStrengthText);
                EditorGUI.indentLevel--;
